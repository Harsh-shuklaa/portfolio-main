...
import freelancerlogo from './assets/company_logo/freelancer_logo.jpeg';
import newtonschoolLogo from './assets/company_logo/newtonschool_logo.png';

// Education Section Logo's
import chitkaraLogo from './assets/education_logo/chitkara_logo.jpg';
import gjuLogo from './assets/education_logo/gju_logo.png';
import gssLogo from './assets/education_logo/gss_logo.png';
import gdvmLogo from './assets/education_logo/gdvm_logo.png';
...
export const leetcodeStats = {
  ...
  export const education = [
    ...
    },
    {
      id: 2,
      img: gssLogo,
      school: "Govt.Sr.Sec.School , Hisar ",
      date: "Apr 2020 - March 2021",
      grade: "85.2%",
      desc: "I completed my class 12 education from Govt.Sr.Sec.School , Hisar, under the BSEH board, where I studied Physics, Chemistry, and Mathematics (PCM) with Computer Science.",
      degree: "BSEH(XII) - PCM with Computer Science",
    },
    {
      id: 3,
      img: gdvmLogo,
  ...
  export const projects = [
    {
      ...
      github: "https://github.com/Harsh-shuklaa/Chess.git",
      webapp: "https://chess-kappa-flax.vercel.app/",
    },
    {
      id: 1,
      title: "QuickNotes",
      description:
        "QuickNotes is a responsive Notes App built using React and Tailwind CSS. It allows users to add, edit, and delete notes, with data stored permanently using LocalStorage.A powerful and user-friendly React.js application designed to uncover and showcase detailed GitHub profile information. Simply enter a GitHub username, and the app fetches comprehensive data, including profile stats, repositories, followers, and contributions. The intuitive interface ensures a seamless experience, making it a must-visit tool for developers and recruiters.",
      image: quickNotesLogo,
      tags: ["HTML", "CSS", "JavaScript", "React JS", "Tailwind CSS", "LocalStorage"],
